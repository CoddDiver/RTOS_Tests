...
int main(void) {
	...
	xTimerHandle SwTimerHandle = NULL;
    const signed char Bob = "Bob";
	SwTimerHandle = xTimerCreate(&Bob,          /* Text name. */
	                                 10, /* Timer period. */
	                                 pdTRUE,             /* Enable auto reload. */
	                                 0,                  /* ID is not used. */
									 application);   /* The callback function. */
	 /* Start timer. */
